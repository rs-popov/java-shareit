...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> createItem(Long ownerId, ItemInputDto itemDto) {
        return post("", ownerId, itemDto);
    }

    public ResponseEntity<Object> updateItem(Long userId, Long itemId, ItemInputDto itemDto) {
