...
public class BookingUnitTests {
    ...
    @Test
    void addBookingWhenItemUnknown_shouldThrowException() {
        when(userRepository.findById(anyLong())).thenReturn(Optional.of(booker));
    ...
    @Test
    void addBookingWhenBookerUnknown_shouldThrowException() {
    ...
    @Test
    void addBookingWhenBookerIsOwner_shouldThrowException() {
    ...
    @Test
    void addBookingWhenItemNotAvailable_shouldThrowException() {
        when(userRepository.findById(anyLong())).thenReturn(Optional.of(booker));
    ...
    @Test
    void approveBookingWhenUnknownBooking_shouldThrowException() {
    ...
    @Test
    void approveBookingByNonOwner_shouldThrowException() {
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.of(notApproveBooking));
        ObjectNotFoundException exception = assertThrows(ObjectNotFoundException.class,
    ...
    @Test
    void approveBookingWhenStatusIsNotWaiting_shouldThrowException() {
    ...
    @Test
    void getBookingByIdByNonOwnerOrNonBooker_shouldThrowException() {
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.of(booking));
        ObjectNotFoundException exception = assertThrows(ObjectNotFoundException.class,
    ...
    @Test
    void getBookingByIdWithUnknownBooking_shouldThrowException() {
        when(bookingRepository.findById(anyLong())).thenReturn(Optional.empty());
        ObjectNotFoundException exception = assertThrows(ObjectNotFoundException.class,
                () -> bookingService.approveBooking(1L, 1L, true));
        assertEquals("Бронирование c id=" + bookingInputDto.getId() + "не найдено.", exception.getMessage());
    ...
    void getAllByBookerWithoutBookings() {
        when(bookingRepository.findAllByBookerId(anyLong(), any()))
                .thenReturn(new PageImpl<Booking>(List.of()));
        ObjectNotFoundException exception = assertThrows(ObjectNotFoundException.class,
    ...
    void getAllByBookerWithStatePast() {
        ...
        assertTrue(bookings.get(1).getEnd().isBefore(LocalDateTime.now()));
        verify(bookingRepository, times(1)).findAllByBookerId(anyLong(), any());
    }
    ...
    @Test
    void getAllByBookerWithStateUnknown_shouldThrowException() {
        when(bookingRepository.findAllByBookerId(anyLong(), any()))
                .thenReturn(new PageImpl<Booking>(List.of(booking, notApproveBooking)));
        BadRequestException exception = assertThrows(BadRequestException.class,
    ...
    @Test
    void getAllByOwnerWithoutItems_shouldThrowException() {
        when(bookingRepository.getAllByOwnerId(anyLong(), any()))
                .thenReturn(new PageImpl<Booking>(List.of()));
        ObjectNotFoundException exception = assertThrows(ObjectNotFoundException.class,
